...
class EoDFlowScreen extends HookConsumerWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildMoodSelector(context, ref, draftState),
            gapH24,
  ...
  Widget _buildMoodSelector(
    ...
    return Container(
      ...
      child: Row(
        children: [
          Text(draft.moodEmoji, style: const TextStyle(fontSize: 34)),
  ...
  Future<void> _openMoodPicker(BuildContext context, WidgetRef ref) async {
        ...
        return SizedBox(
          ...
          child: EmojiPicker(
            onEmojiSelected: (_, emoji) {
              ref.read(draftJournalProvider.notifier).setMood(emoji.emoji);
